...
"""
Django settings for givegetgreen project.
...
# Django settings for givegetgreen - suitable for production
...
ROOT_URLCONF = 'givegetgreen.urls'

# Python dotted path to the WSGI application used by Django's runserver.
# disabled - outsite the app
WSGI_APPLICATION = 'givegetgreen.wsgi.application'
